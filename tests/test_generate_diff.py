...
def test_generate_diff():
  ...
  + verbose: True
    ...
    ('tests/file1.yaml', 'tests/file2.yaml', '''{
  - follow: False
    host: hexlet.io
  - proxy: 123.234.53.22
  - timeout: 50
...
def test_generate_diff_file_identical():
  ...
  test_cases = [
    ('tests/file1.json', 'tests/file1.json', '''{
    follow: False
    host: hexlet.io
    proxy: 123.234.53.22
    timeout: 50
}'''),
    ('tests/file1.yaml', 'tests/file1.yaml', '''{
    follow: False
    host: hexlet.io
    proxy: 123.234.53.22
    timeout: 50
...
def test_generate_diff_one_file_empty():
  test_cases = [
    ('tests/file1.json', 'tests/file-empty.json', '''{
  - follow: False
  - host: hexlet.io
  - proxy: 123.234.53.22
  - timeout: 50
}'''),
     ('tests/file1.yaml', 'tests/empty-file.yaml', '''{
  - follow: False
  - host: hexlet.io
  - proxy: 123.234.53.22
  - timeout: 50
